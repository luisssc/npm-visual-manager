...
export const fr: Translations = {
  ...
  modals: {
    ...
    selectVersionTitle: 'Sélectionner la Version pour {{name}}',
    saveExactEnabled: '--save-exact activé',
  },
  ...
  // Why installed modal
  whyInstalled: {
    tooltip: 'Pourquoi ce paquet est-il installé ?',
    title: 'Pourquoi {{name}} est-il installé ?',
    loading: "Analyse de l'arbre des dépendances...",
    directBadge: 'Directe',
